...
struct WallpaperExtensionConfig: AppExtensionConfiguration {
    func accept(connection: NSXPCConnection) -> Bool {
        ...
        let selectors: [(Selector, Int, Bool)] = [
            ...
            // The private host currently boxes BOOL replies as NSNumber over
            // XPC. Whitelist the reply arguments explicitly so the download
            // probe cannot invalidate an otherwise healthy provider channel.
